            ...
            {hasRate && isParceiroAdm && partnerIsFixed ? (
              ...
              <div>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  {/* Máscara monetária BRL: exibe 0.000,00; armazena valor numérico canônico p/ o payload */}
                  <Input type="text" inputMode="numeric"
                    value={form.hourly_rate !== '' && isFinite(Number(form.hourly_rate))
                      ? Number(form.hourly_rate).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
                      : ''}
                    onChange={e => {
