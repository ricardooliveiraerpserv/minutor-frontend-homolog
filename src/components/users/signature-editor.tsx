...
export function SignatureEditor({ value, onChange, name = '', email = '', lockRole = false, hidePhoto = false }: {
  ...
  useEffect(() => {
    ...
    timer.current = setTimeout(() => {
      ...
      api.post<{ data: { system: string; email: string } }>('/signature/preview', { name, email, signature: valueRef.current })
