...
// ConnectorConnection (Camada A) foi extraído para @/components/environments/connector-connection
// e é reutilizado aqui e no Prosight (Configuração por empresa).
