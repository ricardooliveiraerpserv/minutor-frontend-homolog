...
interface SkillRowDetail { respondent_id: number; name: string; classification: string | null; classification_label: string | null; blacklist: boolean; valor: string | null; partner_id: string; partner_name: string | null; module: string; category: string; level: string; weight: number }
