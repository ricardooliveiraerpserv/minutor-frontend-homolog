...
const CRM_STATUS_OPTS = ['lead', 'prospect', 'cliente', 'contrato_ativo', 'em_renovacao', 'inativo']
...
interface Pipeline {
  id: number; name: string; descricao: string | null; cor: string | null; active: boolean; bloqueado: boolean; arquivado: boolean; tipo: string; stages: Stage[]
}
