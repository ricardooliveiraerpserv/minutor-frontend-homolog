...
export const NAV_CATALOG: CatalogItem[] = [
  ...
  { key: '/projetos/indicadores-apontaveis', label: 'Indicadores de Projetos (Coordenador)',  group: 'Projetos' },
  ...
  { key: '/sustentacao/indicadores', label: 'Indicadores',             group: 'Sustentação' },
